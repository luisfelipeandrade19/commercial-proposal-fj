        ...
        <>
            ...
            <div id='content-presentation' className="flex z-10 w-full">
                <aside id='left' className="relative flex-1">
                    <h1 className="relative text-black font-kanit text-[80px] leading-[0.9] font-extralight pl-25 pt-35">
                        Prazer,
                    </h1>
                    ...
                    <p className="relative text-black font-kanit font-extralight text-[30px] pl-25 pt-20 pb-10 w-315 text-base/8">
                    ...
                    <p className="relative text-dark-blue font-kanit font-bold text-[30px] pl-25 pt-10 w-315 text-base/8">
                ...
                <aside id="right" className="relative pr-20 pt-50">
                    <img src={felipe} alt="Foto de Felipe Jorge" className="w-130 rounded-[100px]" />
                </aside>
            </div>
        </>
    )
