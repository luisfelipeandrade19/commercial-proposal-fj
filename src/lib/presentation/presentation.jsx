            ...
            <div id='content-presentation' className="flex z-10 w-full">
                <aside id='left' className="relative flex-1">
                    <SlideInLeft delay={0.2}>
                        <h1 className="relative text-black font-kanit text-[55px] xl:text-[80px] leading-[0.9] font-extralight pl-16 xl:pl-25 pt-14 xl:pt-20">
                            Prazer,
                        </h1>
                    </SlideInLeft>
                    <SlideInLeft delay={0.3}>
                        <h1 className="relative text-black font-kanit text-[55px] xl:text-[80px] leading-[1.2] font-semibold pl-28 xl:pl-45 
                        tracking-tight bg-linear-to-t from-mid-blue to-dark-blue bg-clip-text text-transparent">
                            Felipe Jorge
                        </h1>
                    </SlideInLeft>
                    <SlideInLeft delay={0.4}>
                        <p className="relative text-black font-kanit font-extralight text-[22px] xl:text-[30px] pl-16 xl:pl-25 pt-7 xl:pt-10 pb-7 xl:pb-10 w-210 xl:w-315 text-base/8">
                    ...
                    <SlideInLeft delay={0.5}>
                        <p className="relative text-black font-kanit font-extralight text-[22px] xl:text-[30px] pl-16 xl:pl-25 pb-7 xl:pb-10 w-210 xl:w-315 text-base/8">
                    ...
                    <SlideInLeft delay={0.7}>
                        <p className="relative text-dark-blue font-kanit font-bold text-[22px] xl:text-[30px] pl-16 xl:pl-25 w-210 xl:w-315 text-base/8">
                            Hoje, meu foco é transformar ideias em visuais
                        </p>
                    </SlideInLeft>
                    <SlideInLeft delay={0.8}>
                        <p className="relative text-mid-blue font-kanit font-bold text-[22px] xl:text-[30px] pl-16 xl:pl-25 w-210 xl:w-315 text-base/8">
                            que conectam, engajam e geram impacto real.
                        </p>
                    </SlideInLeft>
                </aside>
                <aside id="right" className="relative pr-12 xl:pr-20 pt-18 xl:pt-27">
                    <EnterAnimation>
                        <img src={felipe} alt="Foto de Felipe Jorge" className="w-90 xl:w-135 rounded-[100px]" />
                    </EnterAnimation>
                </aside>
