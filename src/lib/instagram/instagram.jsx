            ...
            <div id="instagram-content" className="bg-white">
                ...
                <div id="body" >
                    <SlideInLeft delay={0.5}>
                        <h1 className="relative text-black font-kanit text-[55px] xl:text-[80px] font-semibold  leading-[3.5] pl-12 xl:pl-20
                        tracking-tight bg-linear-to-t from-mid-blue to-dark-blue bg-clip-text text-transparent">
                            Instagram & Design
                        </h1>
                    </SlideInLeft>
                    <SlideInLeft delay={0.6}>
                        <p className="relative text-black pl-12 xl:pl-20 font-kanit font-extralight text-[24px] xl:text-[35px] w-200 xl:w-300">
                    ...
                    <SlideInLeft delay={0.7}>
                        <p className="relative text-black pl-12 xl:pl-20 font-kanit font-extralight text-[24px] xl:text-[35px] w-200 xl:w-300 pt-10 xl:pt-15">Com a quantidade de páginas no instagram disputando atenção dos usuários, aquele que investe em
