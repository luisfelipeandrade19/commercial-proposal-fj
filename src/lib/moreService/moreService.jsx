...
function MoreService() {
    ...
    return (
        <>
            ...
            <div id="content" className='relative font-kanit pl-28 xl:pl-45'>
                <SlideInLeft delay={0.4}>
                    <h2 className='font-extralight text-white text-[72px] xl:text-[110px] leading-[1] pt-22 xl:pt-35'>Precisa de <br />outro serviço?</h2>
                    <hr className='w-85 xl:w-130 h-1 bg-blue-baby ' />
                </SlideInLeft>


                <SlideInBottom delay={0.5}>
                    <div id='Página de vendas e sites' className=' pt-12 xl:pt-18 flex items-center'>
                        <img className='h-2.5 w-2.5 xl:h-3 xl:w-3 ' src={triangulo} alt="Triangulo" />
                        <h1 className='relative text-white font-kanit text-[28px] xl:text-[40px] pl-4 xl:pl-5 font-regular tracking-tight '>
                ...
                <SlideInLeft delay={0.6}>
                    <div className='pt-7 xl:pt-10'>
                        <div className='text-white font-kanit text-[15px] xl:text-[20px] font-regular p-1 w-72 xl:w-100 bg-linear-to-t from-mid-blue to-dark-blue flex items-center justify-center'>
